...
DTB_FILE = $(addprefix $(KERNEL_OUT)/arch/arm/boot/dts/msm8974/,$(patsubst %.dts,%.dtb,$(call G2_DTS_FILE,$(1))))
ZIMG_FILE = $(addprefix $(KERNEL_OUT)/arch/arm/boot/dts/msm8974/,$(patsubst %.dts,%-zImage,$(call G2_DTS_FILE,$(1))))

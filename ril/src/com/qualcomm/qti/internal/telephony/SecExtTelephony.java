...
public class SecExtTelephony extends IExtTelephony.Stub {
    ...
    private static SecExtTelephony sInstance;
    ...
    public static SecExtTelephony getInstance() {
        if (sInstance == null) {
            sInstance = new SecExtTelephony();
        }

        return sInstance;
    }

    private SecExtTelephony() {

...
public class KeyHandler extends DeviceKeyHandler {
    ...
    public boolean handleKeyEvent(KeyEvent event) {
        ...
        if (event.getKeyCode() >= KEY_PEN_DTU && event.getKeyCode() <= KEY_PEN_LP) {
            event = new KeyEvent(event.getDownTime(), event.getEventTime(), event.getAction(),
                    ROTATION_MAP[rotation][event.getKeyCode() - KEY_PEN_DTU],
